...
class WalkerBase(object):
    ...
    def __init__(self, maze, position, default=object, DELAYDELAY=None, xrange=None):
        """Takes a cell object from the maze in question
        NOTE: default must not be object if you want a map of any kind.
        """
        self._delay = DELAYDELAY
        self._isDone = False
        self._maze = maze
        self._cell = position   # This is a cell object
        if default is not object:
            # TODO: избавиться от копирования, изменив значение по умолчанию на вызов функции
    ...
    def init_map(self, default, xrange=None):
